        ...
        <form method="POST" action="{{ route('admin.reports.generate') }}" @submit.prevent="onSubmit"
            ...
            <div class="page-header">
                <div class="page-title">
                    <h1>{{ __('reports::app.reports.tax-report') }}</h1>
                </div>
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-6">
                            <form>
                                <input type="hidden" name="gridName" value="Webkul\Admin\DataGrids\OrderDataGrid">
                                <div class="control-group">
                                    <label for="report_from" class="required">{{ __('reports::app.reports.from') }}</label>

                                    <date>
                                        <input type="text" name="report_from" class="control" value="{{ old('report_from') }}"
                                ...
                                <div class="control-group">
                                    ...
                                    <date>
                                        <input type="text" name="report_to" class="control" value="{{ old('report_to') }}"
